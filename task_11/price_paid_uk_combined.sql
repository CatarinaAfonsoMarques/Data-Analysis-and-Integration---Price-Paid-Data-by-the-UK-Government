...
DROP TABLE IF EXISTS price_paid_transactions_24;

CREATE TABLE price_paid_transactions_24 (
  transaction_id   CHAR(38) NOT NULL,
  price            INT UNSIGNED NOT NULL,
  transfer_date    DATE NOT NULL,
  postcode         VARCHAR(10) DEFAULT NULL,
  property_type CHAR(1) NOT NULL,	-- D = Detached, S = Semi-detached, T = Terraced, F = Flats, O = Other
  newly_built  CHAR(1) NOT NULL,	-- Y/N
  duration     CHAR(1) NOT NULL,	-- F = Freehold, L = Leasehold
  ...
  record_status CHAR(1) NOT NULL,	-- A = Added, C = Changed, D = Deleted
...
LOAD DATA LOCAL INFILE '/home/aid/Downloads/Project/task_11/pp-2024.csv'
	INTO TABLE price_paid_transactions_24
...
DROP TABLE IF EXISTS price_paid_transactions_combined;

CREATE TABLE price_paid_combined AS
SELECT * FROM price_paid_transactions
UNION ALL
SELECT * FROM price_paid_transactions_24;
